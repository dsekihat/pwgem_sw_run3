...
def merge_centrality(filename, taskname_prefix):
    ...
    list_centmin_dst = [ 0, 10, 50]; #destination
    list_centmax_dst = [90, 90, 90]; #destination

    list_occmin = [""]; #source
    list_occmax = [""]; #source

    #list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400", "_TPChadrejorTOFreq_minpt400_TightEvSel"];
    #list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400_wo_detadphi", "_TPChadrejorTOFreq_minpt400_wo_detadphi_TightEvSel"];
    list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400", "_TPChadrejorTOFreq_minpt400_TightEvSel", "_TPChadrejorTOFreq_minpt400_wo_detadphi", "_TPChadrejorTOFreq_minpt400_wo_detadphi_TightEvSel"];
    #list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400", "_TPChadrejorTOFreq_minpt400_wo_detadphi"];
    #list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400_wo_detadphi"];
    #list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400_id14815", "_TPChadrejorTOFreq_minpt400_id20308"];
    #list_taskname_suffix = ["_TPChadrejorTOFreq_minpt400_dcaxy"];
...
if __name__ == "__main__":
    #filename = "AnalysisResults_HL_294526.root";
    #filename = "AnalysisResults_HL_294001.root";
    #filename = "AnalysisResults_HL_294420.root";
    #filename = "AnalysisResults_HL_299220.root";
    #filename = "AnalysisResults_HL_299686.root";
    #filename = "AnalysisResults_HL_309527.root";
    #filename = "AnalysisResults_HL_313263.root";
    #filename = "AnalysisResults_HL_314544.root";
    #filename = "AnalysisResults_HL_315520.root";
    #filename = "AnalysisResults_HL_316686.root";
    #filename = "AnalysisResults_HL_319300.root";
    #filename = "AnalysisResults_HL_319559.root"; #without prefiter without detadphi cut
    #filename = "AnalysisResults_HL_319736.root"; #with prefiter deta > 0.04, with deta > 0.04 cut
    #filename = "AnalysisResults_HL_320049.root"; #with prefiter deta > 0.03, with deta > 0.03 cut
    #filename = "AnalysisResults_HL_320161.root"; #with prefiter deta > 0.02, with deta > 0.02 cut
    #filename = "AnalysisResults_HL_320499.root"; #with prefiter deta > 0.04, with deta > 0.04 cut, ITS cluster size < 3
    #filename = "AnalysisResults_HL_328470.root"; #with prefiter deta > 0.04, with deta > 0.04 cut, IsGoodITSLayersAll
    #filename = "AnalysisResults_HL_328095.root"; #with prefiter deta > 0.04, with deta > 0.04 cut, IsGoodITSLayersAll
    #filename = "AnalysisResults_HL_329829.root";
    filename = "AnalysisResults_HL_330348.root";
    #filename = "AnalysisResults_HL_315230.root";
    #filename = "AnalysisResults_HL_311554.root";
    #filename = "AnalysisResults_HL_301030.root";
    taskname_prefix = "dielectron";
    #taskname_prefix = "dielectron-mc";
    merge_centrality(filename, taskname_prefix);

    filename_all = filename.replace(".root", "_*.root");
    filename_dst = filename.replace(".root", "_merged_centrality.root");
    ...
    #filename = "AnalysisResults2.root";
